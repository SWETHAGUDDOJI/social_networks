	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="papp.jsp" accesskey="2" title="">Patient</a></li>
...
<div class="wrapper">
	<div id="welcome" class="container">
		...
		String sql = "select * from udisease where hid='"+session.getAttribute("uid")+"' and pid='pending'";
		List<String> lt = Dao.getPDiseases(sql);
		Iterator<String> itr = lt.iterator();
		%>
			<h2>Patient Approval</h2>
			<table>
			<thead>
			<tr><th>UserID</th><th>Disease</th><th>Symptom</th><th>Approve</th><th>Reject</th></tr>
			</thead>
			<%
			while(itr.hasNext()){
			%>
			...
			String da = itr.next();
			%>
			<td><a href="PApprove?da=<%=da %>" class="button alt">Approve</a></td>
			<td><a href="PReject?da=<%=da %>" class="button alt">Reject</a></td></tr>
			</tbody>
			<%} %>
			</table>
		</div>
