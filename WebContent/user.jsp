	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li><a href="hospital.jsp" accesskey="4" title="">Hospitals</a></li>
				<li><a href="medical.jsp" accesskey="5" title="">Medical</a></li>
				<li class="active"><a href="user.jsp" accesskey="6" title="">User</a></li>
			</ul>
		</div>
	</div>
</div>
<div class="wrapper">
	<div id="welcome" class="container">
		...
		<tr><td><input type="submit" value="Login" class="alt" /></td><td><a href="userreg.jsp">Registration</a></td></tr>
		</table>
		</form>
	</div>
