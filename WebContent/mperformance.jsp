	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="mperformance.jsp" accesskey="6" title="">MPerformance</a></li>
...
while(itr.hasNext()){
	String hid = itr.next();
	sql = "select count(*) from mfeedback where hid='"+hid+"'";
	int hcount = Dao.getCount(sql);
	sql = "select SUM(rating) FROM mfeedback WHERE hid='"+hid+"'";
