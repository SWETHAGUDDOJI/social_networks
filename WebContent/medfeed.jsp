	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="medfeed.jsp" accesskey="5" title="">Feedback</a></li>
...
<div class="wrapper">
	<div id="welcome" class="container">
		...
		String sql = "select * from mfeedback where hid='"+session.getAttribute("uid")+"'";
		List<String> lt = Dao.getMReview(sql);
		Iterator<String> itr = lt.iterator();
		%>
			<h2>Feedback</h2>
			<table>
			<thead>
			<tr><th>PID</th><th>Medicine</th><th>Review</th><th>Rating</th></tr>
			</thead>
			<%
			while(itr.hasNext()){
			%>
			...
			<td><%=itr.next() %></td>
			<%
			int i = Integer.parseInt(itr.next());
			%>
			<td><%
				for(int k=1;k<=i;k++){
			%>
