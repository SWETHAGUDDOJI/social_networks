	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="medical.jsp" accesskey="5" title="">Medical</a></li>
...
<div class="wrapper">
	<div id="welcome" class="container">
		...
		<tr><td><input type="submit" value="Login" class="alt"/></td><td><a href="mreg.jsp">Registration</a> </td></tr>
		</table>
		</form>
	</div>
