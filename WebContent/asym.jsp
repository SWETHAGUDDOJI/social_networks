	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li><a href="mdis.jsp" accesskey="2" title="">Diseases</a></li>
				<li class="active"><a href="asym.jsp" accesskey="3" title="">Add Medicine</a></li>
...
<div class="wrapper">
	<div id="welcome" class="container">
		<div class="title">
			...
			<table>
			<thead>
			<tr><th>Disease</th><th>Symptoms</th><th>Medicine</th><th>Add</th></tr>
			</thead>
			<tbody>
			<tr><td><input type="text" name="dis"/></td>
